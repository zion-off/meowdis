...
import { translateLLen, translateLPop, translateLPush, translateLRange, translateRPop, translateRPush } from "./lists";
import { translateSAdd, translateSCard, translateSIsMember, translateSMembers, translateSRem } from "./sets";
